...
3. create package folder architecture, e.g. devtools::create("../readme2pkg/")
...
1) if you should work on functions or use installed package functions (a good check to see if package functions are actually working)
...
Eventually things will feel circular and hairy if you do to much development in .Rmd.  So, you will want the homebase of your code to be in the R folder and in a .R file.
